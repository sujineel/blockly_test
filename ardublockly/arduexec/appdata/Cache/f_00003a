...
Blockly.Msg.ARD_BUILTIN_LED = "내장된 LED 설정";  // untranslated
...
Blockly.Msg.ARD_DIGITALREAD = "디지털 값 읽기 핀번호";  // untranslated
Blockly.Msg.ARD_DIGITALREAD_TIP = "Read digital value on a pin: HIGH or LOW";  // untranslated
Blockly.Msg.ARD_DIGITALWRITE = "디지털 값 설정 핀번호";  // untranslated
Blockly.Msg.ARD_DIGITALWRITE_TIP = "Write digital value HIGH or LOW to a specific Port";  // untranslated
Blockly.Msg.ARD_FUN_RUN_LOOP = "아두이노 반복 loop(): ";  // untranslated
Blockly.Msg.ARD_FUN_RUN_SETUP = "아두이노 처음 한 번 실행 setup():";  // untranslated
...
Blockly.Msg.ARD_MAP = " 숫자 변환(Map)";  // untranslated
Blockly.Msg.ARD_MAP_TIP = "Re-maps a number from [0-1024] to another.";  // untranslated
Blockly.Msg.ARD_MAP_VAL = "값(value)을 [0-";  // untranslated
Blockly.Msg.ARD_NOTONE = "소리 끔 핀번호";  // untranslated
...
Blockly.Msg.ARD_PULSEON = "로 펄스값을 핀번호";  // untranslated
Blockly.Msg.ARD_PULSEREAD = "읽기(Read)";  // untranslated
Blockly.Msg.ARD_PULSETIMEOUT = "펄스 시작을 기다릴 시간 ";  // untranslated
...
Blockly.Msg.ARD_SERIAL_PRINT = "화면 출력";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT_NEWLINE = "새로운 줄 추가";  // untranslated
...
Blockly.Msg.ARD_SERIAL_SETUP = "설정";  // untranslated
Blockly.Msg.ARD_SERIAL_SETUP_TIP = "Selects the speed for a specific Serial peripheral";  // untranslated
Blockly.Msg.ARD_SERIAL_SPEED = ":  속도";  // untranslated
Blockly.Msg.ARD_SERVO_READ = "서보모터 값 읽기 핀번호";  // untranslated
Blockly.Msg.ARD_SERVO_READ_TIP = "Read a Servo angle";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE = "서보모터 설정 핀";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_DEG_180 = "도 (0~180)로";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_TIP = "Set a Servo to an specified angle";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_TO = "을 ";  // untranslated
Blockly.Msg.ARD_SETTONE = "음정 설정 핀번호";  // untranslated
Blockly.Msg.ARD_SPI_SETUP = "설정";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_CONF = "환경설정:";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_DIVIDE = "클럭 나누기";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_LSBFIRST = "LSBFIRST";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_MODE = "SPI 데이터 모드 설정 ";  // untranslated
...
Blockly.Msg.ARD_SPI_SETUP_SHIFT = "데이터 이동";  // untranslated
...
Blockly.Msg.ARD_SPI_TRANS_SLAVE = "슬레이브 핀";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_TIP = "Send a SPI message to an specified slave device.";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_VAL = "전송";  // untranslated
...
Blockly.Msg.ARD_STEPPER_MOTOR = "스텝모터:";  // untranslated
Blockly.Msg.ARD_STEPPER_PIN1 = "핀 1번";  // untranslated
Blockly.Msg.ARD_STEPPER_PIN2 = "핀 2번";  // untranslated
Blockly.Msg.ARD_STEPPER_REVOLVS = "스텝 모터의 1바퀴 스텝 수 입력";  // untranslated
Blockly.Msg.ARD_STEPPER_SETUP = "설정 스텝모터";  // untranslated
Blockly.Msg.ARD_STEPPER_SETUP_TIP = "Configures a stepper motor pinout and other settings.";  // untranslated
Blockly.Msg.ARD_STEPPER_SPEED = "회전 속도 설정 (rpm)";  // untranslated
Blockly.Msg.ARD_STEPPER_STEP = "회전 스텝모터";  // untranslated
Blockly.Msg.ARD_STEPPER_STEPS = "스텝 수";  // untranslated
Blockly.Msg.ARD_STEPPER_STEP_TIP = "Turns the stepper motor a specific number of steps.";  // untranslated
Blockly.Msg.ARD_TIME_DELAY = "멈춤";  // untranslated
...
Blockly.Msg.ARD_TIME_INF = "무한루프 (end program)";  // untranslated
Blockly.Msg.ARD_TIME_INF_TIP = "Wait indefinitely, stopping the program.";  // untranslated
Blockly.Msg.ARD_TIME_MICROS = "현재 경과 시간 (microseconds)";  // untranslated
...
Blockly.Msg.ARD_TIME_MILLIS = "현재 경과 시간 (milliseconds)";  // untranslated
...
Blockly.Msg.ARD_TONEFREQ = "주파수";  // untranslated
